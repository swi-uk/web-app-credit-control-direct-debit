...
class AbsoluteSftpConnector implements BureauConnectorInterface
{
    ...
    {
        return BureauSubmitResult::failure('SFTP submission not implemented.', [
    ...
    {
        throw new RuntimeException('SFTP download not implemented.');
    }
}
